...
declare -a XBB_APPLICATION_COMMON_DEPENDENCIES=( zlib gmp mpfr mpc isl libiconv xz zstd binutils-cross gcc-cross newlib-cross expat libunistring gettext gpm ncurses readline bzip2 libffi mpdecimal sqlite libxcrypt openssl python3 gdb-cross )
