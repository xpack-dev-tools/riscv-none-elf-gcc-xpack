...
title: xPack GNU RISC-V Embedded GCC v15.2.0-1 released
...
download_url: https://github.com/xpack-dev-tools/riscv-none-elf-gcc-xpack/releases/tag/v15.2.0-1/
...
Version **15.2.0-1.1** is a new release; it follows the GNU GCC release.
...
xpack-riscv-none-elf-gcc-15.2.0-1-darwin-arm64.tar.gz
...
xpack-riscv-none-elf-gcc-15.2.0-1-linux-arm64.tar.gz
