...
**xPack GNU RISC-V Embedded GCC** is a standalone
cross-platform (Windows, macOS, GNU/Linux)binary distribution of GNU RISC-V Embedded GCC,
...
- **Star** the project on [GitHub](https://github.com/xpack-dev-tools/riscv-none-elf-gcc-xpack/): It helps others discover our work.
