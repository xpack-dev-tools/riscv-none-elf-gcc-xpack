---
title: Information for xPack GNU RISC-V Embedded GCC maintainers
...
generated on x86_64 GNU/Linux, using [mingw-w64](https://mingw-w64.org).
...
The builds currently run on 5 dedicated machines (x86_64 GNU/Linux,
armhf GNU/Linux, aarch64 GNU/Linux, x86_64 macOS and arm64 macOS).
...
For x86_64 macOS, first run the build on the development machine
(`wksi`, a recent macOS):
...
* <code>xpack-riscv-none-elf-gcc-{ customField('upstreamVersion') }-{ customField('xpackSubversion') }-darwin-x64.tar.gz.sha</code>
...
* <code>xpack-riscv-none-elf-gcc-{ customField('upstreamVersion') }-{ customField('xpackSubversion') }-darwin-arm64.tar.gz.sha</code>
...
##### Build the x86_64 GNU/Linux binaries
...
* <code>xpack-riscv-none-elf-gcc-{ customField('upstreamVersion') }-{ customField('xpackSubversion') }-linux-x64.tar.gz.sha</code>

##### Build the x86_64 Windows binaries
...
* <code>xpack-riscv-none-elf-gcc-{ customField('upstreamVersion') }-{ customField('xpackSubversion') }-win32-x64.zip</code>
* <code>xpack-riscv-none-elf-gcc-{ customField('upstreamVersion') }-{ customField('xpackSubversion') }-win32-x64.zip.sha</code>
...
* <code>xpack-riscv-none-elf-gcc-{ customField('upstreamVersion') }-{ customField('xpackSubversion') }-linux-arm64.tar.gz.sha</code>
...
* <code>xpack-riscv-none-elf-gcc-{ customField('upstreamVersion') }-{ customField('xpackSubversion') }-linux-arm.tar.gz.sha</code>
...
Note: If this is the first time riscv-none-elf-gcc is executed, on GNU/Linux
it is necessary
to configure the rights, otherwise LIBUSB will issue the _libusb_open
failed: LIBUSB_ERROR_ACCESS_ error.

<CodeBlock language="sh"> {
`sudo cp ~/Downloads/xpack-riscv-none-elf-gcc-${ customField('upstreamVersion') }-${ customField('xpackSubversion') }/contrib/60-riscv-none-elf-gcc.rules /etc/udev/rules.d
sudo udevadm control --reload-rules`
} </CodeBlock>

Then it is possible to start riscv-none-elf-gcc:

<CodeBlock language="console"> {
`$ .../xpack-riscv-none-elf-gcc-${ customField('upstreamVersion') }-${ customField('xpackSubversion') }/bin/riscv-none-elf-gcc -f "board/stm32f4discovery.cfg"
xPack Open On-Chip Debugger ${ customField('upstreamVersion') }-01004-g9ea7f3d64-dirty
Licensed under GNU GPL v2
For bug reports, read
	https://riscv-none-elf-gcc.org/doc/doxygen/bugs.html
...
available in the xpack-arm-none-eabi-riscv-none-elf-gcc package, which uses
...
- commit the `develop` branch of `xpack/web-jekyll` GitHub repo;
  use a message like _xPack GNU RISC-V Embedded GCC v{ customField('upstreamVersion') }-{ customField('xpackSubversion') } released_
- push to GitHub
...
- <code>npm dist-tag ls @xpack-dev-tools/riscv-none-elf-gcc</code>
- <code>npm dist-tag add @xpack-dev-tools/riscv-none-elf-gcc@{ customField('upstreamVersion') }-{ customField('xpackSubversion') }.{ customField('npmSubversion') } latest</code>
- <code>npm dist-tag ls @xpack-dev-tools/riscv-none-elf-gcc</code>

In case the previous version is not functional and needs to be unpublished:

- <code>npm unpublish @xpack-dev-tools/riscv-none-elf-gcc@{ customField('upstreamVersion') }-{ customField('xpackSubversion') }.{ customField('npmSubversion') }</code>
...
- paste the release name like **xPack GNU RISC-V Embedded GCC v{ customField('upstreamVersion') }-{ customField('xpackSubversion') } released**
