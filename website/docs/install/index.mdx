...
title: How to install the xPack GNU RISC-V Embedded GCC
...
<CodeBlock language="sh"> {
`export PATH=$HOME/AppData/Roaming/xPacks/\@pack-dev-tools/riscv-none-elf-gcc/${customField('xpackVersion')}.${customField('npmSubversion')}/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/Library/xPacks/\@pack-dev-tools/riscv-none-elf-gcc/${customField('xpackVersion')}.${customField('npmSubversion')}/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/.local/xPacks/@xpack-dev-tools/riscv-none-elf-gcc/${customField('xpackVersion')}.${customField('npmSubversion')}/.content/bin:$PATH
`} </CodeBlock>
...
- <code>xpack-riscv-none-elf-gcc-{customField('xpackVersion')}-win32-x64.zip</code>
...
example <code>C:\\Users\\ilg\\AppData\\Roaming\\xPacks\\riscv-none-elf-gcc\\xpack-riscv-none-elf-gcc-{customField('xpackVersion')}</code>.
...
- <code>xpack-riscv-none-elf-gcc-{customField('xpackVersion')}-darwin-x64.tar.gz</code>- <code>xpack-riscv-none-elf-gcc-{customField('xpackVersion')}-darwin-arm64.tar.gz</code>
...
example <code>/Users/ilg/Library/xPacks/riscv-none-elf-gcc/xpack-riscv-none-elf-gcc-{customField('xpackVersion')}</code>:

<CodeBlock language="console"> {
`mkdir -p ~/Library/xPacks/riscv-none-elf-gcc
cd ~/Library/xPacks/riscv-none-elf-gcc

tar xvf ~/Downloads/xpack-riscv-none-elf-gcc-${customField('xpackVersion')}-darwin-x64.tar.gz
chmod -R -w xpack-riscv-none-elf-gcc-${customField('xpackVersion')}
`} </CodeBlock>
...
- <code>xpack-riscv-none-elf-gcc-{customField('xpackVersion')}-linux-x64.tar.gz</code>- <code>xpack-riscv-none-elf-gcc-{customField('xpackVersion')}-linux-arm64.tar.gz</code>- <code>xpack-riscv-none-elf-gcc-{customField('xpackVersion')}-linux-arm.tar.gz</code>
...
example <code>/home/ilg/.local/xPacks/riscv-none-elf-gcc/xpack-riscv-none-elf-gcc-{customField('xpackVersion')}</code>:

<CodeBlock language="console"> {
`mkdir -p ~/.local/xPacks/riscv-none-elf-gcc
cd ~/.local/xPacks/riscv-none-elf-gcc

tar xvf ~/Downloads/xpack-riscv-none-elf-gcc-${customField('xpackVersion')}-linux-x64.tar.gz
chmod -R -w xpack-riscv-none-elf-gcc-${customField('xpackVersion')}
`} </CodeBlock>
