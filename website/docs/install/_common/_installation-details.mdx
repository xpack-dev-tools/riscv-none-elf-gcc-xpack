...
* identify the platform-specific archive for the desired version
  of @xpack-dev-tools/riscv-none-elf-gcc, download it into a cache and unpack
...
* create a local symbolic link
  such as <code>xpacks/@xpack-dev-tools/riscv-none-elf-gcc</code> pointing to the
...
* add <code>@xpack-dev-tools/riscv-none-elf-gcc</code> to
  `package.json` as a
  development dependency; this associates a specific version of xPack GNU RISC-V Embedded GCC with
