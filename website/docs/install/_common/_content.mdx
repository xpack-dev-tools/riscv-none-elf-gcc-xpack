...
<CodeBlock language="sh"> {
`xpm install @xpack-dev-tools/riscv-none-elf-gcc@14.2.0-3.1 --verbose
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/AppData/Roaming/xPacks/@xpack-dev-tools/riscv-none-elf-gcc/14.2.0-3.1/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/.local/xPacks/@xpack-dev-tools/riscv-none-elf-gcc/14.2.0-3.1/.content/bin:$PATH
`} </CodeBlock>
...
<ul>
<li><code>xpack-riscv-none-elf-gcc-14.2.0-3-win32-x64.zip</code></li>
</ul>
...
example <code>C:\\Users\\ilg\\AppData\\Roaming\\xPacks\\riscv-none-elf-gcc\\xpack-riscv-none-elf-gcc-14.2.0-3</code>.
...
<ul>
<li><code>xpack-riscv-none-elf-gcc-14.2.0-3-darwin-x64.tar.gz</code></li>
<li><code>xpack-riscv-none-elf-gcc-14.2.0-3-darwin-arm64.tar.gz</code></li>
</ul>
...
example <code>/Users/ilg/Library/xPacks/riscv-none-elf-gcc/xpack-riscv-none-elf-gcc-14.2.0-3</code>:

<CodeBlock language="console"> {
`mkdir -p ~/Library/xPacks/riscv-none-elf-gcc
cd ~/Library/xPacks/riscv-none-elf-gcc

tar xvf ~/Downloads/xpack-riscv-none-elf-gcc-14.2.0-3-darwin-x64.tar.gz
chmod -R -w xpack-riscv-none-elf-gcc-14.2.0-3
`} </CodeBlock>
...
<ul>
<li><code>xpack-riscv-none-elf-gcc-14.2.0-3-linux-x64.tar.gz</code></li>
<li><code>xpack-riscv-none-elf-gcc-14.2.0-3-linux-arm64.tar.gz</code></li>
</ul>
...
example <code>/home/ilg/.local/xPacks/riscv-none-elf-gcc/xpack-riscv-none-elf-gcc-14.2.0-3</code>:
