...
The **xPack GNU RISC-V Embedded GCC** may be installed automatically, utilising the `xpm` command
(the recommended method), or manually, by downloading and unpacking one of the
platform-specific archives.

## Automated installation

The easiest (and recommended) method to install xPack GNU RISC-V Embedded GCC
...
it is also possible to install xPack GNU RISC-V Embedded GCC only globally in
...
In order to access the xPack GNU RISC-V Embedded GCC binaries installed in
...
<CodeBlock language="sh"> {
`export PATH=$HOME/AppData/Roaming/xPacks/@xpack-dev-tools/riscv-none-elf-gcc/14.3.0-1.1/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/Library/xPacks/@xpack-dev-tools/riscv-none-elf-gcc/14.3.0-1.1/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/.local/xPacks/@xpack-dev-tools/riscv-none-elf-gcc/14.3.0-1.1/.content/bin:$PATH
`} </CodeBlock>
...
<ul>
<li><code>xpack-riscv-none-elf-gcc-14.3.0-1-win32-x64.zip</code></li>
</ul>
...
example <code>C:\\Users\\ilg\\AppData\\Roaming\\xPacks\\riscv-none-elf-gcc\\xpack-riscv-none-elf-gcc-14.3.0-1</code>.
...
<ul>
<li><code>xpack-riscv-none-elf-gcc-14.3.0-1-darwin-x64.tar.gz</code></li>
<li><code>xpack-riscv-none-elf-gcc-14.3.0-1-darwin-arm64.tar.gz</code></li>
</ul>
...
example <code>/Users/ilg/Library/xPacks/riscv-none-elf-gcc/xpack-riscv-none-elf-gcc-14.3.0-1</code>:

<CodeBlock language="console"> {
`mkdir -p ~/Library/xPacks/riscv-none-elf-gcc
cd ~/Library/xPacks/riscv-none-elf-gcc

tar xvf ~/Downloads/xpack-riscv-none-elf-gcc-14.3.0-1-darwin-x64.tar.gz
chmod -R -w xpack-riscv-none-elf-gcc-14.3.0-1
`} </CodeBlock>
...
<ul>
<li><code>xpack-riscv-none-elf-gcc-14.3.0-1-linux-x64.tar.gz</code></li>
<li><code>xpack-riscv-none-elf-gcc-14.3.0-1-linux-arm64.tar.gz</code></li>
</ul>
...
example <code>/home/ilg/.local/xPacks/riscv-none-elf-gcc/xpack-riscv-none-elf-gcc-14.3.0-1</code>:

<CodeBlock language="console"> {
`mkdir -p ~/.local/xPacks/riscv-none-elf-gcc
cd ~/.local/xPacks/riscv-none-elf-gcc

tar xvf ~/Downloads/xpack-riscv-none-elf-gcc-14.3.0-1-linux-x64.tar.gz
chmod -R -w xpack-riscv-none-elf-gcc-14.3.0-1
`} </CodeBlock>
