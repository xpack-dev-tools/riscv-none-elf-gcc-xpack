...
export const platforms = {
    "linux-x64": {
        sectionName: 'x86_64 GNU/Linux',
        machineName: 'a 64-bit x86 GNU/Linux'
    },
    "win32-x64": {
        sectionName: 'x86_64 Windows',
        machineName: 'a 64-bit x86 GNU/Linux'
    },
    "linux-arm64": {
        sectionName: 'aarch64 GNU/Linux 64-bit',
        machineName: 'a 64-bit Arm GNU/Linux'
    },
    "linux-arm": {
        sectionName: 'armhf GNU/Linux 32-bit',
        machineName: 'a 32-bit Arm GNU/Linux'
    },
}
