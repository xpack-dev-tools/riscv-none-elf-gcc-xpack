...
title: How to release riscv-none-elf-gcc
...
```sh
rm -f ~/Work/xpack-dev-tools/riscv-none-elf-gcc-xpack.git/build-assets/package-lock.json
git -C ~/Work/xpack-dev-tools/riscv-none-elf-gcc-xpack.git pull
...
```sh
xpm run clear-all-project-builds -C ~/Work/xpack-dev-tools/riscv-none-elf-gcc-xpack.git/build-assets
```
...
xpm run trigger-workflow-build-linux-arm64 -C ~/Work/xpack-dev-tools/riscv-none-elf-gcc-xpack.git/build-assets
xpm run trigger-workflow-build-linux-arm -C ~/Work/xpack-dev-tools/riscv-none-elf-gcc-xpack.git/build-assets
```
...
<a href="https://www.npmjs.com/package/@xpack-dev-tools/riscv-none-elf-gcc?activeTab=versions">npmjs.com</a>.
...
npm dist-tag add @xpack-dev-tools/riscv-none-elf-gcc@${customField('xpackVersion')}.${customField('npmSubversion')} latest
npm dist-tag ls @xpack-dev-tools/riscv-none-elf-gcc
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`npm unpublish @xpack-dev-tools/riscv-none-elf-gcc@${customField('xpackVersion')}.${customField('npmSubversion')}
`} </CodeBlock>
...
in https://xpack-dev-tools.github.io/riscv-none-elf-gcc-xpack/blog/
