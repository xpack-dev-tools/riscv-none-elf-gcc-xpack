...
- <code>xpack-riscv-none-elf-gcc-14.2.0-3-{props.platform}.{props.platform === 'win32-x64' ? 'zip' : 'tar.gz'}</code>
- <code>xpack-riscv-none-elf-gcc-14.2.0-3-{props.platform}.{props.platform === 'win32-x64' ? 'zip' : 'tar.gz'}.sha</code>
