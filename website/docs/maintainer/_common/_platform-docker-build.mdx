...
- <code>xpack-riscv-none-elf-gcc-12.5.0-1-{props.platform}.{props.platform === 'win32-x64' ? 'zip' : 'tar.gz'}</code>
- <code>xpack-riscv-none-elf-gcc-12.5.0-1-{props.platform}.{props.platform === 'win32-x64' ? 'zip' : 'tar.gz'}.sha</code>
