...
* <code>xpack-riscv-none-elf-gcc-{customField('xpackVersion')}-{props.platform}.tar.gz</code>
* <code>xpack-riscv-none-elf-gcc-{customField('xpackVersion')}-{props.platform}.tar.gz.sha</code>
