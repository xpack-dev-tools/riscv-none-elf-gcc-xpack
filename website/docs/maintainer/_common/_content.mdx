...
**@xpack-dev-tools/riscv-none-elf-gcc** is an xpm package that packs platform specific archives, built with the [xPack Build Box (XBB)](https://xpack.github.io/xpack-build-box/).
...
tagged like **v14.2.0-3** (mind the dash in the middle!) and
named like **xPack GNU RISC-V Embedded GCC v14.2.0-3** (mind the dash),
