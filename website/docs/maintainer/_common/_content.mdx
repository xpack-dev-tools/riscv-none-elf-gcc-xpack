...
(such as **14.2.0-3.1**) with the following expression:
...
- In `CHANGELOG.md`, add the release date and a message
  such as _**\* v14.2.0-3 released**_
...
tagged such as **v14.2.0-3** (mind the dash in the middle!) and
named such as **xPack GNU RISC-V Embedded GCC v14.2.0-3** (mind the dash),
...
- **Commit** all changes with the message
  _**package.json: update URLs for 14.2.0-3.1 release**_
