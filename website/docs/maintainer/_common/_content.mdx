...
**@xpack-dev-tools/riscv-none-elf-gcc** is an xpm package that packages platform-specific archives, built with the [xPack Build Box (XBB)](https://xpack.github.io/xpack-build-box/).
...
```sh
rm -rf ~/Work/xpack-dev-tools/riscv-none-elf-gcc-xpack.git/build-assets/package-lock.json
git -C ~/Work/xpack-dev-tools/riscv-none-elf-gcc-xpack.git pull

npm --prefix ~/Work/xpack-dev-tools/riscv-none-elf-gcc-xpack.git/build-assets install
xpm install -C ~/Work/xpack-dev-tools/riscv-none-elf-gcc-xpack.git/build-assets
...
xpm run trigger-workflow-test-docker-linux-arm64 -C ~/Work/xpack-dev-tools/riscv-none-elf-gcc-xpack.git/build-assets
```
...
named such as **xPack GNU RISC-V Embedded GCC v15.2.0-1** (mind the dash),
...
watching the riscv-none-elf-gcc-xpack project.
...
- Navigate to the [GitHub Releases](https://github.com/xpack-dev-tools/riscv-none-elf-gcc-xpack/releases) page
...
npm --prefix ~/Work/xpack-dev-tools/riscv-none-elf-gcc-xpack.git/build-assets install && \
xpm install -C ~/Work/xpack-dev-tools/riscv-none-elf-gcc-xpack.git/build-assets && \
xpm run test-release -C ~/Work/xpack-dev-tools/riscv-none-elf-gcc-xpack.git/build-assets
```
