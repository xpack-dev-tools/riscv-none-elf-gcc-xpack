...
`$ tree -L 2 ~/Library/xPacks/\@xpack-dev-tools/riscv-none-elf-gcc/${ customField('releaseVersion') }.${ customField('npmSubversion') }/.content/
/Users/ilg/Library/xPacks/\@xpack-dev-tools/riscv-none-elf-gcc/${ customField('releaseVersion') }.${ customField('npmSubversion') }/.content/
├── README.md
├── bin
