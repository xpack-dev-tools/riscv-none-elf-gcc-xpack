...
such as <code>14.2.0-<b>3</b></code>. When
published as an npm package, the version receives
a fifth number,
such as <code>14.2.0-3.<b>1</b></code>.

Since adherence of third-party packages to SemVer is not guaranteed,
it is recommended to avoid referencing the xPack GNU RISC-V Embedded GCC dependency via
SemVer expressions
such as <code>^14.2.0-3</code> or <code>~14.2.0-3</code>, and
prefer exact matches,
such as <code>14.2.0-3.1</code>.
