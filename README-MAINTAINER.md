...
Update both full 5 numbers (`12.3.0-1.2`) and short 3 numbers (`12.3.0`)
versions in:
...
```sh
.../riscv-none-elf-gcc-12.3.0-1.2/bin/riscv-none-elf-gcc --version
...
- update `CHANGELOG.md`, add a line like _* v12.3.0-1.2 published on npmjs.com_
- commit with a message like _CHANGELOG: publish npm v12.3.0-1.2_
- `npm pack` and check the content of the archive, which should list
  only the `package.json`, the `README.md`, `LICENSE` and `CHANGELOG.md`;
  possibly adjust `.npmignore`
- `npm version 12.3.0-1.2`; the first 4 numbers are the same as the
...
- `npm dist-tag add @xpack-dev-tools/riscv-none-elf-gcc@12.3.0-1.2 latest`
- `npm dist-tag ls @xpack-dev-tools/riscv-none-elf-gcc`

In case the previous version is not functional and needs to be unpublished:

- `npm unpublish @xpack-dev-tools/riscv-none-elf-gcc@12.3.0-1.2`
