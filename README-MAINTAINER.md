...
Determine the GCC version (like `11.5.0`) and update the `scripts/VERSION`
file; the format is `11.5.0-1`. The fourth digit is the number of the
...
Update both full 5 numbers (`11.5.0-1.1`) and short 3 numbers (`11.5.0`)
versions in:
...
Use the new version, suffixed by `pre`, like `11.5.0-1.pre`.
...
total 262456
-rw-r--r--  1 ilg  staff  131934771 Aug 23 01:57 xpack-riscv-none-elf-gcc-11.5.0-1-darwin-x64.tar.gz
-rw-r--r--  1 ilg  staff        118 Aug 23 01:57 xpack-riscv-none-elf-gcc-11.5.0-1-darwin-x64.tar.gz.sha
```
...
total 263048
-rw-r--r--  1 ilg  staff  128160032 Aug 23 01:22 xpack-riscv-none-elf-gcc-11.5.0-1-darwin-arm64.tar.gz
-rw-r--r--  1 ilg  staff        120 Aug 23 01:22 xpack-riscv-none-elf-gcc-11.5.0-1-darwin-arm64.tar.gz.sha
```
...
total 138680
-rw-r--r-- 1 ilg ilg 142003499 Aug 22 23:14 xpack-riscv-none-elf-gcc-11.5.0-1-linux-x64.tar.gz
-rw-r--r-- 1 ilg ilg       117 Aug 22 23:14 xpack-riscv-none-elf-gcc-11.5.0-1-linux-x64.tar.gz.sha
```
...
total 150400
-rw-r--r-- 1 ilg ilg 153999860 Aug 22 23:06 xpack-riscv-none-elf-gcc-11.5.0-1-win32-x64.zip
-rw-r--r-- 1 ilg ilg       114 Aug 22 23:06 xpack-riscv-none-elf-gcc-11.5.0-1-win32-x64.zip.sha
```
...
total 135604
-rw-r--r-- 1 ilg ilg 138853247 Aug 22 19:26 xpack-riscv-none-elf-gcc-11.5.0-1-linux-arm64.tar.gz
-rw-r--r-- 1 ilg ilg       119 Aug 22 19:26 xpack-riscv-none-elf-gcc-11.5.0-1-linux-arm64.tar.gz.sha
```
...
total 129736
-rw-r--r-- 1 ilg ilg 132843190 Aug 22 19:15 xpack-riscv-none-elf-gcc-11.5.0-1-linux-arm.tar.gz
-rw-r--r-- 1 ilg ilg       117 Aug 22 19:15 xpack-riscv-none-elf-gcc-11.5.0-1-linux-arm.tar.gz.sha
```
...
```sh
.../riscv-none-elf-gcc-11.5.0-1.1/bin/riscv-none-elf-gcc --version
riscv-none-elf-gcc (xPack GNU RISC-V Embedded GCC x86_64) 11.5.0
```
...
named like **xPack GNU RISC-V Embedded GCC v11.5.0-1** (mind the dash),
...
- commit the `develop` branch of `xpack/web-jekyll` GitHub repo;
  use a message like _xPack GNU RISC-V Embedded GCC v11.5.0-1 released_
- push to GitHub
...
- commit all changes, use a message like
  _package.json: update urls for 11.5.0-1 release_ (without _v_)
...
- `npm dist-tag add @xpack-dev-tools/riscv-none-elf-gcc@11.5.0-1.1 latest`
- `npm dist-tag ls @xpack-dev-tools/riscv-none-elf-gcc`

In case the previous version is not functional and needs to be unpublished:

- `npm unpublish @xpack-dev-tools/riscv-none-elf-gcc@11.5.0-1.1`
...
- paste the release name like **xPack GNU RISC-V Embedded GCC v11.5.0-1 released**
...
```console
Subject: xPack GNU RISC-V Embedded GCC v11.5.0-1 released

Version 11.5.0-1 is a new release of the xPack GNU RISC-V Embedded GCC; it follows the GNU GCC release.
