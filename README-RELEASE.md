...
- name the tag like **v10.1.0-1.2** (mind the dash in the middle!)
- select the target branch (like sifive-gcc-10.1.0-gme)
- name the release like **xPack GNU RISC-V Embedded GCC v10.1.0-1.2**
(mind the dash and the space)
- as description, use:

```markdown
![Github Releases (by Release)](https://img.shields.io/github/downloads/xpack-dev-tools/riscv-none-embed-gcc-xpack/v10.1.0-1.2/total.svg)

Version v10.1.0-1.2 is a new release of the **xPack GNU RISC-V Embedded GCC** package, following the SiFive release v2020.12.0 from Dec 19th, 2020.
...
bash ~/Downloads/riscv-none-embed-gcc-xpack.git/tests/scripts/native-test.sh \
  "https://github.com/xpack-dev-tools/riscv-none-embed-gcc-xpack/releases/download/v10.1.0-1.2/"
```
...
- name the post like: **xPack GNU RISC-V Embedded GCC v10.1.0-1.2 released**
- as `download_url` use the tagged URL like `https://github.com/xpack-dev-tools/riscv-none-embed-gcc-xpack/releases/tag/v10.1.0-1.2/`
...
xpack-riscv-none-embed-gcc-10.1.0-1.2-linux-arm.tar.gz
...
- commit the `develop` branch of `xpack/web-jekyll` GitHub repo; use a message
  like **xPack GNU RISC-V Embedded GCC v10.1.0-1.2 released**
- push
- wait for the GitHub Pages build to complete
- the preview web is <https://xpack.github.io/web-preview/news/>
...
- open the `package.json` file
- check the latest commits `npm run git-log`
- update `CHANGELOG.md`, add a line like _- v10.1.0-1.2.1 published on npmjs.com_
- commit with a message like _CHANGELOG: publish npm v10.1.0-1.2.1_
- `npm version 10.1.0-1.2.1`; the first 5 numbers are the same as the
  GitHub release; the sixth number is the npm specific version
- `npm pack` and check the content of the archive, which should list
  only the `package.json`, the `README.md`, `LICENSE` and `CHANGELOG.md`
...
For 32-bit Windows, 32-bit Intel GNU/Linux and 32-bit RISC-V, install manually.
...
```sh
~/opt/xPacks/@xpack-dev-tools/riscv-none-embed-gcc/10.1.0-1.2.1/.content/bin/riscv-none-embed-gcc --version
...
```sh
~/Library/xPacks/@xpack-dev-tools/riscv-none-embed-gcc/10.1.0-1.2.1/.content/bin/riscv-none-embed-gcc --version
...
```doscon
%USERPROFILE%\AppData\Roaming\xPacks\@xpack-dev-tools\riscv-none-embed-gcc\10.1.0-1.2.1\.content\bin\riscv-none-embed-gcc --version
